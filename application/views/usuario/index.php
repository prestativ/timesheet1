                            ...
                            <table class="table data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo ($user->active == 1 ? '<span class="badge badge-pill badge-success mb-1"><i class="fas fa-lock-open"></i>&nbsp;Sim</span>' : 
                                                                             '<span class="badge badge-pill badge-warning mb-1"><i class="fas fa-lock"></i>&nbsp;Não</span>'); ?></td>                                        
                                        <td class ="text-right">
                                            ...
                                            <button type="button" class="btn btn-icon btn-danger" data-toggle="modal" data-target="#user-<?php echo $user->id; ?>" title="Excluir <?php echo $this->router->fetch_class(); ?>"><i class="ik ik-trash-2"></i></button>                                                                                        
                                        </td>
                                    </tr>
