                            ...
                            <table class="table data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class ="text-right">
                                            <a data-toggle="tooltip" data-placement="bottom" title="Editar <?php echo $this->router->fetch_class(); ?>"  href="<?php echo base_url($this->router->fetch_class().'/core/'.$projeto->id); ?>" class="btn btn-icon btn-primary"><i class="ik ik-edit-2"></i></a>                                         
                                            <button type="button" class="btn btn-icon btn-danger" data-toggle="modal" data-target="#cliente-<?php echo $projeto->id; ?>" title="Excluir <?php echo $this->router->fetch_class(); ?>"><i class="ik ik-trash-2"></i></button>                                                                                        
                                        </td>
                                    </tr>
                                    <div class="modal fade" id="cliente-<?php echo $projeto->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a data-toggle="tooltip" data-placement="bottom" title="Excluir <?php echo $this->router->fetch_class(); ?>"  href="<?php echo base_url($this->router->fetch_class().'/del/'.$projeto->id); ?>" class="btn btn-danger">Sim, excluir</a>                                         
                                                </div>
                                            </div>
                                        </div>
                                    </div>                                    
